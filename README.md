...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-night-d0ac)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-night-d0ac
```

A live public deployment of this template is available at [https://round-night-d0ac.templates.workers.dev](https://round-night-d0ac.templates.workers.dev)
